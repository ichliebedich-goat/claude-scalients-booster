...
const caseStudies = [
  {
    metric: "+$142K/mo",
    label: "Revenue generated through automated lead scoring",
    detail: "Deployed in 3 weeks for a B2B SaaS company",
  },
  {
    metric: "12.5x ROI",
    label: "Maintained consistently over 6 months",
    detail: "AI-powered ad optimization pipeline",
  },
  {
    metric: "89% faster",
    label: "Document processing time reduction",
    detail: "Custom extraction model for financial services",
  },
];
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-xl">
            Real outcomes from production deployments. No vanity metrics.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          ...
          >
            <img
              src={heroDashboard}
              alt="AI dashboard showing campaign analytics and ROAS metrics"
